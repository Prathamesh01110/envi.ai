...
const Business: React.FC = () => (
  <section id="features" className={`${layout.section}`}>
    <div className={layout.sectionInfo}>
      ...
      Enhance Conversations & Streamline Workflows
      </h2>
      <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
      Enhance the way you connect with AI-driven chat, real-time voice actions, and seamless offline access. Communicate faster, clearer, and from anywhere.
      </p>
      <Button styles="mt-10" />
    </div>
